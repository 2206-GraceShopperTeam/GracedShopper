...
async function createInitialProducts() {
  ...
  try {
    const productsToCreate = [
      { name: "XPS13", description: "11th Gen I-51135G7, Intel Iris Xe Graphics, 512 GB M.2, 13.4 Inch Display, 60Hz, OLED, Touchscreen, 8GB Memory 4237 mHz DDR4X", price: 1299.99, category: "DELL"},
      ...
      { name: "XPS13", description: "6900HX, NVIDIA RTX 3070Ti, 1 TB M.2, 17.3 Inch Display, 165Hz, NVIDIA G-SYNC, 16GB 4800 Mhz DDR5", price: 2350, category: "DELL"},
      ...
      {name: "HP ENVY Laptop", description: "11th Gen Intel Core i7 processor; Intel Iris Xe Graphics, 1 TB PCIe NVMe M.2 SSD, 17.3 diagonal 4K UHD, IPS, WLED-backlit, 3840 x 2160, 32 GB DDR4-3200 SDRAM", price: 849.99, category: 'HP'},
      ...
      {name: "Pavilion Areo Laptop 13-be1097nr", description: "AMD Ryzen 5, AMD Radeon, 512 GB SSD, 13.3 Inch WUXGA", price: 699.99, category: "HP"},

      
      { name: "MacBook Air", description: "Apple M2 chip,256GB SSD,13.6 inch Display, 8GB Memory", price: 1199.00, category:"Apple"},
      { name: "MacBook Pro", description: "Apple M1 Pro chip,512GB SSD,14 inch Display, 16GB Memory", price: 1999.00, category:"Apple"},
      { name: "MacBook Air (M1)", description: "Apple M1 chip,256GB SSD,13.3 inch Display, 8GB Memory", price: 899.99, category:"Apple"},
