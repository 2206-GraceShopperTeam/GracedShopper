...
import {Home,Header,Login,Products,Cart,Checkout,AllUsers,UserInfo,Dell,HP,ASUS,Apple,AddProduct,SingleCartProduct} from './'
...
useEffect(()=>{
  ...
  return (
    <div className="app-container">
      ...
      <Routes>
         <Route path="/SingleCartProduct" element={<SingleCartProduct />} />
